...
% FIXME: greek letters shouldn't be in italic here.
...
% FIXME: Rogério - Exemplos de espectros de diferentes posições e com V500 e
% V1200.

\subsection{Amostra}

% FIXME: Rogério - Colocar mais detalhes da amostra final. Por exemplo, quantas
% têm espectro nuclear, tipos morfológicos, etc. Não quero ter que ler o paper
% pra saber isso, um resumo seria bom.
...
% FIXME: Rogério - O que são os números? Dar uma boa explicação da figura.
...
$-2,3$ e $+0,4$; vide \citeal{Mateus2006}). A Figura
...
% FIXME: Rogério - Sugiro colocar alguns detalhes aqui (e.g. equações 9 e 10 do
% paper do Cid).
