...
% FIXME: Acho que deveria seguir um pequeno paragrafo dizendo o que voce fez
% sobre morfologia de galaxias e o que mais tem no capitulo, por dois motivos. O
% primeiro eh que isso estah com cara de introducao, mas nao eh mais. E segundo
% que estah desconectado do que veio antes.
...
% TODO: desenhar também o perfil de Hubble-Reynolds.
...
% FIXME: Ficou confuso. Por que só no cap 7?
...
PSF\footnote{{\em Point Spread Function.}}, tratada em detalhes no Capítulo
\ref{sec:psf}. A grosso modo, levar em conta a PSF significa considerar que a
luz que atinge determinada posição no detector não é proveniente apenas de uma
região pontual no céu, e sim de uma região extensa que depende dos instrumentos
e da turbulência atmosférica. Efetivamente, objetos pontuais tornam-se
``borrões'' na imagem observada.
