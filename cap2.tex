...
detentor do recorde.}, o PPAK/PMAS era o instrumento de sua classe com o tamanho
de campo, $>1\,\mathrm{arcmin}^2$. Ele consiste em um maço de 331 fibras ópticas
cobrindo o campo de observação, direcionado a um espectrógrafo de fenda longa
que espalha a luz sobre um detector CCD\footnote{{\em Charge Coupled Device}.}.
...
deslocando o telescópio uma fração de {em spaxel} em direções diferentes
formando um triângulo, tal que as 3 exposições cobrem toda a àrea a ser
observada. O cubo de dados é reconstruído utilizando uma técnica chamada {\em
dithering}.
...
utilizando a grade de difração V500, com resolução $\lambda / \Delta\lambda
...
A segunda, utilizando a grade de difração V1200, com resolução $\lambda /
...
espectro, incluindo a descontinuidade de Balmer, \Hdelta, \Hgamma e \OIII4363.
...
tesselação dos cubos de dados descrito a seguir, foi chamado de QBICK. Para mais
...
idades de  $0,001$ a $14\,\mathrm{Ga}$, e $\log Z/Z_\odot$ de $-2.3$ a $+0.33$.
