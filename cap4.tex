...
% FIXME: Natalia - Como escolher o melhor ajuste então?
...
% FIXME: Natalia - ``em ambos os lados do núcleo''?
% FIXME: Abilio - Comentário sobre o trabalho de johnston pode aparecer também
% na discussão no final.
...
Foi feita uma versão modificada do \textsc{imfit} em forma de biblioteca
...
%
% * Este capítulo deveria ser dividido entre introdução e metodologia.
% * Qual o objetivo deste capítulo?
