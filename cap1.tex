...
espectros individualmente, embora na verdade, nos cubos do CALIFA os {\em
spaxels} vizinhos estão correlacionados devido ao {\em seeing} do céu e ao
processo de observação. Há a queda na relação sinal/ruído (S/N) nas regiões mais
...
\starlight, ferramentas básicas em nossa análise doe cubos de dados. O Capítulo
...
% TODO Falar do resultado da síntese.
