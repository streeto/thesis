...
% FIXME: Tens que destacar no inicio de cada capitulo o que *voce* fez. Aqui por
% exemplo tens que colocar que o pycasso foi feito exclusivamente por vc.

% FIXME: Outra coisa que acho que falta em todos os capitulos (voltando a este
% comentario depois de comecar a ler o cap 4) eh um breve resumo do que o leitor
% vai encontrar pela frente. Ajuda a costurar a historia. Nao tinha ideia do que
% ia encontrar nesse capitulo e que ia ser um flash dos papers, ainda mais
% porque ele nao foi descrito na introducao.
...
% FIXME: Transformar figuras em listings.
