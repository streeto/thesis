...
survey.\fixme(atualizar pro DR2)
...
\TODO Comparar califa com outros surveuy que vem. (Manga, sami).
...
se tornar um tanto burocrática\fixme (achar um termo melhor).
Trabalhar com todas as galáxias do {\em survey} fica virtualmente impossível
desta forma. Assim, da necessidade de manipular os resultados da síntese dos
cubos de dados das galáxias do CALIFA, nasceu o software PyCASSO.
