...
\begin{figure}
	...
	radial de brilho, no painel inferior, pode ser comparado com o perfil da Figura
...
anti-correlacionadas, conforme o painel de {\em zoom} nos espectros integrados.
Esta degenerescência precisa ser estudada mais a fundo no futuro.
...
padrão da média de $3\%$. Para o disco a razão média é $0,99 \pm 0.05$, isto é,
um desvio médio de $1\%$, e um desvio padrão da média de $5\%$. A ordem de
magnitude destes desvios não é nenhuma surpresa, levando em conta que foram
